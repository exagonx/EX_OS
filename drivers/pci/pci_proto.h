 ...
 *
 * -----------------------------------------------------------------------------
 * ⚠️ NON C'E' UNA SCRITTURA DI CONFIGURAZIONE GENERICA, ED E' VOLUTO
 *
 ...
 *
 * ⚠️ PCI_MSG_DISABILITA non è la coppia decorativa di PCI_MSG_ABILITA.
 ...
 *
 * ⚠️ NON C'E' LA DIMENSIONE DELLA FINESTRA, E NON SI PUO' AGGIUNGERE
