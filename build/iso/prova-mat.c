 ...
 *
 * ! SERVE -lm. Dietro questi nomi c'e' openlibm (la `msun` di FreeBSD in
 ...
 *
 * -----------------------------------------------------------------------------
 * ! PERCHE' I RISULTATI SONO MOLTIPLICATI PER MILLE E STAMPATI COME INTERI
 *
...
int main(void)
{
     ...
     *
     * ! LA PROVA CHE CONTA NON E' IL NUMERO. `rintl` e `nearbyintl`
