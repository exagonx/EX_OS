 ...
 *
 * ! QUANTO POCO C'E' QUI E' IL PUNTO. La versione unix/ di questo file e'
 ...
 *
 * ! NIENTE _control87: la precisione della FPU resta quella predefinita.
...
void fb_hInit( void )
{
	...
	/* ! SI PRENDE UNA VOLTA SOLA, all'avvio: CURDIR puo' cambiare mentre
...
{
	/* ! NON si libera __fb_startup_cwd: fb_hEnd() puo' essere chiamata
