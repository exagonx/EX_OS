 ...
 * CURDIR ed EXEPATH.
 *
 * ! IL SEPARATORE RESTA '/', e non si converte in '\' come fa la porta
 ...
 *
 * ! SI RICAVA DA argv[0], e questo ha un limite che va detto: EX-OS non
 ...
 * ragionevole.
 *
 * ! SE UN GIORNO SERVISSE ESATTO, la strada e' una syscall che renda il
