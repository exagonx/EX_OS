 ...
 *
 * ⚠️ LE IMPLEMENTAZIONI NON SONO NOSTRE, ED E' UNA SCELTA. Fino ad agosto
 ...
 *
 * ⚠️ CHI USA QUESTE FUNZIONI DEVE LINKARE -lm. Le tre eccezioni sono
...
/* ⚠️ extern "C" anche qui: openlibm e' compilata da un compilatore C e in
 ...
 *
 * ⚠️ NON SONO SINONIMI DI <, <=, >, >=. Con un operando NaN, `a < b` e
...
/* ⚠️ sqrt e' `fsqrt` dell'x87, quindi correttamente arrotondata — una
...
/* ⚠️ Questa NON viene da openlibm — a openlibm 0.8.7 manca. La aggiunge
