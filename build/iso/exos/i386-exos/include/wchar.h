 ...
 *
 * ⚠️ FINO AD AGOSTO 2026 QUESTO FILE NON PROMETTEVA NIENTE, e la nota che
 ...
 *
 * ⚠️ LA CODIFICA E' LATIN-1: un wchar_t E' un byte esteso a 32 bit. Non e'
...
/* ⚠️ %ls e %lc NON sono supportate: tornano -1 con EILSEQ invece di
 * stampare qualcosa di sbagliato. Il perche' sta in lib/libc.c, sopra
 * vswprintf. E ⚠️ swprintf NON e' snprintf: quando non ci sta torna -1,
