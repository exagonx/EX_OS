...
MODIFICHE = [
    ...
    # ! La regola di compilazione va scritta a mano: la regola implicita
    ...
    #
    # ! CONFIGURE E CONFIGURE.AC INSIEME. Il primo e' quello che gira, il
    ...
    #
    # ! NON E' UN RIPIEGO PER FARLO COMPILARE: e' che quel programma non ha
    ...
    #
    # ! NON E' UN AGGIRAMENTO PER FAR COMPILARE. GCC puo' spedire le sue
    ...
    (
        ...
        "\n"
        "#ifdef __exos__\n"
        "  /* ! SI DICE, NON SI IGNORA. Chi ha impostato la variabile si\n"
    ...
    # ! E l'#endif che chiude il ramo aperto qui sopra. Va in una voce a
...
def marca_modifica(percorso):
    ...
    # ! IL COMMENTO VA SCRITTO NELLA LINGUA DEL FILE. Fino ad agosto 2026
...
! -j1 E NON -j$(nproc): la macchina di sviluppo ha 4 GB, e i file
...
! --enable-clocale=generic E' OBBLIGATORIO. Senza, --with-newlib porta il
...
! PRIMA della libstdc++ ci vuole libm nel sysroot: il suo <cmath> scrive
