...
/* ! -Ttext-segment E' PARTE DEL CONTRATTO, non una preferenza.  Senza,
...
/* I programmi utente sono statici e non rilocabili: vedi la nota in testa
   al file.  */
/* ! DUE COSE DIVERSE CHE SI CHIAMANO UGUALE.  DWARF2_UNWIND_INFO 0 (qui
...
/* =============================================================================
   ...
   ! Senza queste righe il bersaglio prendeva i valori predefiniti, che per
