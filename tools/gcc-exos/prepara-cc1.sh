...
#
# -----------------------------------------------------------------------------
# ⚠️ TRE MACCHINE, NON DUE, E VANNO TENUTE DISTINTE
#
...
#
# -----------------------------------------------------------------------------
# ⚠️ LE RISPOSTE PRECOTTE, e perche' NON sono bugie
#
...
#
# -----------------------------------------------------------------------------
# ⚠️ --disable-fixincludes, E NON E' UN AGGIRAMENTO
#
...
#
# -----------------------------------------------------------------------------
# ⚠️ --prefix=/exos E' IL PERCORSO DENTRO EX-OS, non su Linux
#
...
# ⚠️ cc1 si LEGA a GMP, MPFR e MPC: devono essere gia' compilate PER
