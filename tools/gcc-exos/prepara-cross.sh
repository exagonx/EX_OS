...
#
# ! VANNO INSTALLATI IN DUE POSTI, e non e' una ridondanza:
#
...
#
# ! UN WRAPPER NON SOVRASCRIVE MAI UN BINUTILS VERO.
#
...
CC="${CC:-gcc}"
# ! -fno-asynchronous-unwind-tables NON e' un dettaglio di ottimizzazione.
