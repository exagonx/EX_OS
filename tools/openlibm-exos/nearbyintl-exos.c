 ...
 *
 * ⚠️ NON E' UNA NOSTRA CONFIGURAZIONE SBAGLIATA: E' UNA LACUNA A MONTE.
 ...
 * ⚠️ Una sola assenza fa dichiarare non conforme l'header intero, e la
 ...
 *
 * -----------------------------------------------------------------------------
 * ⚠️ LA DIFFERENZA FRA rint E nearbyint E' UNA SOLA, E STA TUTTA QUI
 *
 ...
 *
 * ⚠️ fnstenv MASCHERA TUTTE LE ECCEZIONI come effetto collaterale (lo dice
...
long double nearbyintl(long double x)
{
    ...
    /* ⚠️ IL RISULTATO VA FORZATO IN MEMORIA PRIMA DI fldenv, E QUESTA
     ...
     *
     * ⚠️ Chi tocca questa funzione non sposti la riga sotto il fldenv. */
