 ...
 *
 * ⚠️ LA CONSEGUENZA E' CHE NON CI SONO PIPE, ed e' visibile da qui: la
...
/* ⚠️ I TRE NULL NON SONO UN "DA FARE": sono la dichiarazione che questo
...
/* ⚠️ NON SI APRE NIENTE, e non e' una scorciatoia: spawn_ex vuole il
		     ...
		     const char **errmsg, int *err)
{
  ...
  /* ⚠️ PEX_STDERR_TO_STDOUT NON SI PUO' FARE, e vale la pena dire perche':
