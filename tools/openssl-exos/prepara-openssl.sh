...
#
# -----------------------------------------------------------------------------
# ! SI CONFIGURA CON `no-` DAPPERTUTTO, E OGNUNO HA UNA RAGIONE
#
...
#
# -----------------------------------------------------------------------------
# ! --with-rand-seed=getrandom, E FUNZIONA SENZA PATCH
#
...
mkdir -p "$BUILD"
# ! configdata.pm scrive apps/include/configuration.h nell'albero di
