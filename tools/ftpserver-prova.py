...
=============================================================================
! NON E' UN SERVER FTP. Non ha utenti, non ha permessi, non ha limiti: fa
...
def sicuro(base, arg=""):
    ...
    ! PRENDE BASE E ARGOMENTO SEPARATI, e la prima versione no: univa i
...
def servi(conn, addr):
    ...
    while True:
        ...
        # ! QUESTI SEI SERVONO A PROVARE IL CLIENT, e senza di loro le
        ...
        # un client rotto da un server che non sa rispondere.
            ...
            if os.path.exists(n):
                rinomina_da = n
                # ! 350 e non 250: "ho capito, ora dimmi il nuovo nome".
            ...
            # ! L'indirizzo annunciato e' quello con cui il CLIENT ci
