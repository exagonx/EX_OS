 ...
 *
 * ⚠️ NESSUN #include, E NON E' PIGRIZIA — e' la stessa regola di
 ...
 *
 * ⚠️ NIENTE new, delete, ECCEZIONI NE' DISTRUTTORI VIRTUALI: tirerebbero
...
/* ⚠️ `static const` con inizializzazione COSTANTE: il puntatore alla
