 ...
 *
 * -----------------------------------------------------------------------------
 * ! SI USA UN VETTORE DI PROVA PUBBLICATO, NON UN VALORE INVENTATO
 *
 ...
 *
 * -----------------------------------------------------------------------------
 * ! RAND_bytes PUO' LEGITTIMAMENTE FALLIRE, E VA DETTO INVECE CHE
 * NASCOSTO
 *
...
int main(void)
{
    ...
    /* ! EVP E NON SHA256_Init/Update/Final: quelle sono l'API di
