 ...
 *
 * ⚠️ UNA RIGA SOLA, E CON g++. Fino al 3 agosto 2026 qui c'era scritto il
 ...
 *   4. le ECCEZIONI             -> ⚠️ e' il pezzo piu' grosso: __cxa_throw,
 ...
 *
 * ⚠️ CHE LE ECCEZIONI FUNZIONINO NON ERA SCONTATO. Lo svolgimento dello
...
/* ⚠️ I risultati in virgola mobile si moltiplicano per mille e si
...
int main()
{
    ...
    try {
        ...
        std::printf("  ⚠️ at(10) non ha lanciato: SBAGLIATO\n");
