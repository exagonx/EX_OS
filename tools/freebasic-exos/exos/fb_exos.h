 ...
 *
 * ⚠️ LGPL e non GPL: questo file entra nella runtime di FreeBASIC
 ...
 *
 * ⚠️ MODELLATA SU dos/, NON SU unix/. Sembra il contrario di quel che si
...
/* ⚠️ OFFSET A 32 BIT, ED E' UN LIMITE VERO: 2 GB per file.
 *
 ...
 * ⚠️ Devono restare macro e non funzioni vuote — il codice comune le usa
