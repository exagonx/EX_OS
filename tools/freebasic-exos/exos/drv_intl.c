 ...
 * e dei giorni.
 *
 * ⚠️ SONO QUELLE DELLA LOCALE "C", E NON C'E' NIENTE DA INTERROGARE. La
 ...
 *
 * ⚠️ LA DATA E' ISO 8601 (yyyy-mm-dd) E NON L'AMERICANA. La locale "C" di
...
/* ⚠️ L'INDICE 1 E' LA DOMENICA, non il lunedi': e' la convenzione di
