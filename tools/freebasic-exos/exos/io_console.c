 ...
 *
 * ⚠️ NIENTE SEQUENZE DI ESCAPE. La versione unix/ emette \e%G per entrare
 ...
 * come sono.
 *
 * ⚠️ SI CONTA IL CURSORE MENTRE SI STAMPA. Vedi il commento in testa a
...
void fb_ConsolePrintBufferEx( const void *buffer, size_t len, int mask )
{
	...
	for( i = 0; i < len; i++ ) {
		...
		/* ⚠️ Lo ZERO diventa spazio, e non e' una stranezza nostra: in
