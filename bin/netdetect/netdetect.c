 ...
 *
 * -----------------------------------------------------------------------------
 * ⚠️ `-c` NON SI FIDA DI AVER LANCIATO IL DRIVER: CONTROLLA CHE SIA VIVO
 *
 ...
 *
 * -----------------------------------------------------------------------------
 * ⚠️ LE SCHEDE ISA NON SI VEDONO DA QUI, E NON E' UN DIFETTO DI QUESTO FILE
 *
...
static const SchedaNota g_note[] = {
    ...
    /* ⚠️ Solo ASCII nei nomi: printf("%-44s") conta BYTE, non colonne, e
 ...
 *
 * ⚠️ SI CONTROLLA CHI HA RISPOSTO. ipc_recv consegna il prossimo messaggio
 ...
 *
 * ⚠️ SERVE PERCHE' LA TABELLA DICE COSA SERVIREBBE, NON COSA C'E'. Il
