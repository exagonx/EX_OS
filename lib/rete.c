 ...
 *
 * ⚠️ SI USA UNA SCADENZA BREVE. Questa funzione viene chiamata quando
...
void rete_istruzioni(void)
{
    ...
    /* ⚠️ SI INDICA UN PASSO SOLO. Elencare tutti i comandi mancanti
...
/* =============================================================================
 * ⚠️ SI ASPETTA UN POCO, E NON E' UNA CORTESIA
 *
