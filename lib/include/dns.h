 ...
 *
 * -----------------------------------------------------------------------------
 * ! PERCHE' UN MODULO DA COMPILARE DENTRO I PROGRAMMI, E NON UN SERVIZIO
 *
 ...
 *
 * -----------------------------------------------------------------------------
 * ! NON E' gethostbyname() E NON DEVE SEMBRARLO
 *
 ...
 *
 * ! È SINCRONA E PUÒ BLOCCARE PER QUALCHE SECONDO. Un programma che deve
