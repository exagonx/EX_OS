 ...
 * =============================================================================
 *
 * <stdlib.h> — allocazione, conversioni numeriche, qsort.
 *
 ...
 * compilatore da portare — scrive #include <stdlib.h> e si aspetta che
 * funzioni.
 *
...
#ifndef EXOS_STDLIB_H
#define EXOS_STDLIB_H
