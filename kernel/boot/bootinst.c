 ...
 *
 * ! Ne discende che riscrivere quei due file OBBLIGA a rieseguire
 * l'installazione.
 *
 ...
 *
 * ! `solo_verifica` E' IL MOTIVO PER CUI QUESTA FUNZIONE ESISTE. Calcola
    ...
    if (nome_k  == NULL) nome_k  = "kernel.bin";
{
    ...
    /* ! QUI FINISCE LA VERIFICA E COMINCIA LA SCRITTURA. Chi ha chiesto
