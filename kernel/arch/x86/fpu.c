 ...
 *
 * ! TUTTO A TEMPO DI ESECUZIONE, MAI A TEMPO DI COMPILAZIONE. Lo stesso
 ...
 *
 * ! L'ORDINE DELLE DOMANDE E' OBBLIGATO. Non si puo' chiedere a CPUID se
...
int fpu_init(void)
{
     ...
     *
     * ! E SERVE FXSR, NON SOLO SSE. Sono due bit distinti di CPUID
    ...
    if (g_sse_attivo) {
        /* ! MXCSR VA MESSA A MANO. FNINIT azzera l'x87 ma non tocca
...
/* ! LE DUE VIE NON SONO INTERCAMBIABILI. FNSAVE scrive 108 byte in un
 ...
 *
 * ! FXSAVE PRETENDE L'ALLINEAMENTO A 16. Il campo fpu_state del PCB e'
