...
; --- Registro CR4 -------------------------------------------------------------
; ! CR4 NON ESISTE SUL 386 E SUI PRIMI 486. Chi chiama deve gia' sapere
...
;
; ! NON SI PUO' CHIEDERE A CPUID SE CPUID ESISTE. L'unico modo e' provare
...
;
; ! QUESTE DUE RIGHE DI ASSEMBLY VALGONO PIU' DI TUTTO IL RESTO DEL
...
;
; ! IL BUFFER DEVE ESSERE GIA' PRESENTE IN RAM. rep insw non e'
