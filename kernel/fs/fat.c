 ...
 *
 * ⚠️ LO SFRATTO DI UNO SLOT SPORCO DEVE RIVERSARLO PRIMA.
 ...
 *
 * ⚠️ LO MARCA SUBITO, PRIMA DI RESTITUIRLO. Non e' un dettaglio: fra
 ...
 *
 * ⚠️ L'ORDINE CONTA: il cluster nuovo e' gia' marcato fine catena da
 ...
 *
 * ⚠️ RIFIUTA invece di storpiare. Un nome troppo lungo o con caratteri
 ...
 *
 * ⚠️ La catena si libera PRIMA di marcare la voce libera. All'inverso, una
 ...
 *
 * ⚠️ IL CONTEGGIO DEI CLUSTER LIBERI SI DICHIARA IGNOTO, NON SI INVENTA.
 ...
 *
 * ⚠️ RICHIEDE UN FILE CONTIGUO, E LO VERIFICA. Un file frammentato ha una
