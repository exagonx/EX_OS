 ...
 *
 * ⚠️ ext2 NON ha un giornale, e questo driver non ne inventa uno. Fra la
                        ...
                        uint32_t dim, uint32_t blocchi_512)
{
    ...
    /* Le marche temporali restano a zero: EX-OS non ha un orologio letto
     * dal kernel, e una data inventata e' peggio di una evidentemente
     * convenzionale — soprattutto se cade nel futuro, perche' da li' in
     * avanti ogni fsck si lamenta. */
}
