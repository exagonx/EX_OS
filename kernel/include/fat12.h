...
/* ! `offset` e' arrivato ad agosto 2026, e prima non c'era: la scrittura
 ...
 * ! Un fallimento e' il segnale di un avvio da CD per emulazione
 * floppy: vedi il commento in kernel/fs/fat12.c. */
int  fat12_pronto(void);

int  fat12_delete(const char *path);
/* Cambia il NOME senza spostare i dati. ! SOLO nella stessa directory
