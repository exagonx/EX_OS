...
typedef struct PACKED {
    ...
    /* =====================================================================
     * Framebuffer VESA — riempito da Stage 2, che e' l'unico a poterlo fare
     *
     * ! fb_addr == 0 VUOL DIRE MODO TESTO, ed e' il caso normale. La
     * modalita' grafica si imposta con INT 10h, cioe' con il BIOS, cioe' in
     * modo reale: quando questo kernel comincia a girare quella porta e'
     * gia' chiusa. Se qui c'e' zero non e' andato storto niente — vuol dire
     * che nessuno ha chiesto la grafica, o che la scheda non offriva la
 ...
 *
 * ! Alzarla ancora non e' gratis: ogni MB in piu' e' un MB che l'utente
