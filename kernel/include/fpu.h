...
/* =============================================================================
 * ⚠️ 512 BYTE E NON 108, da agosto 2026: SERVE FXSAVE, NON FNSAVE
 *
 ...
 *
 * ⚠️ SERVE PERCHE' EX-OS DEVE GIRARE ANCHE SU UN 486. Non si puo'
 ...
 *
 * ⚠️ MMX NON HA BISOGNO DI NIENTE DAL KERNEL, e questo e' il punto meno
